...
interface ValidatorCollectionInterface extends CollectionInterface, AppendableInterface, LockAppendInterface, RemovableInterface, LockRemoveInterface, LockableObjectInterface
{
    /**
     * @param string $class
     * @param mixed ...$params
